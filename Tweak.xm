...
-(BOOL)isServiceSupported:(unsigned)arg1 {
	HBLogDebug(@"isServiceSupported called");
	BOOL val = %orig;
	return val;
}
-(unsigned)vendorId {
	HBLogDebug(@"vendorId called");
	unsigned val = %orig;
	return val;
}
-(id)description {
	HBLogDebug(@"description called");
	id val = %orig;
	return val;
}
-(id)name {
	HBLogDebug(@"name called");
	id val = %orig;
	return val;
}
-(long long)compare:(id)arg1  {
	HBLogDebug(@"compare called");
	long long val = %orig;
	return val;
}
-(int)type {
	HBLogDebug(@"type called");
	int val = %orig;
	return val;
}
-(id)copyWithZone:(NSZone*)arg1 {
	HBLogDebug(@"copyWithZone called");
	id val = %orig;
	return val;
}
-(int)batteryLevel {
	HBLogDebug(@"batteryLevel called");
	int val = %orig;
	return val;
}
-(void)connect {
	HBLogDebug(@"connect called");
	return %orig;
}
-(void)disconnect {
	HBLogDebug(@"disconnect called");
	return %orig;
}
-(BOOL)magicPaired {
	HBLogDebug(@"magicPaired called");
	BOOL val = %orig;
	return val;
}
-(void)unpair {
	HBLogDebug(@"unpair called");
	return %orig;
}
-(unsigned)productId {
	HBLogDebug(@"productId called");
	unsigned val = %orig;
	return val;
}
-(BOOL)setUserName:(id)arg1  {
	HBLogDebug(@"setUserName called");
	BOOL val = %orig;
	return val;
}
-(void)_clearName {
	HBLogDebug(@"_clearName called");
	return %orig;
}
-(BOOL)_isNameCached {
	HBLogDebug(@"_isNameCached called");
	BOOL val = %orig;
	return val;
}
-(id)scoUID {
	HBLogDebug(@"scoUID called");
	id val = %orig;
	return val;
}
-(unsigned long long)connectedServicesCount {
	HBLogDebug(@"connectedServicesCount called");
...
-(BOOL)magicPairedDeviceNameUpdated {
	HBLogDebug(@"magicPairedDeviceNameUpdated called");
	BOOL val = %orig;
	return val;
}
-(BOOL)isAccessory {
	HBLogDebug(@"isAccessory called");
	BOOL val = %orig;
	return val;
}
-(void)connectWithServices:(unsigned)arg1  {
	HBLogDebug(@"connectWithServices called");
	return %orig;
}
-(void)acceptSSP:(long long)arg1  {
	HBLogDebug(@"acceptSSP called");
	return %orig;
}
-(void)startVoiceCommand {
	HBLogDebug(@"startVoiceCommand called");
	return %orig;
}
-(void)endVoiceCommand {
	HBLogDebug(@"endVoiceCommand called");
	return %orig;
}
-(void)setConnectingServicemask:(unsigned)arg1 {
	HBLogDebug(@"setConnectingServicemask called");
	return %orig;
}
-(unsigned)getConnectingServiceMask {
	HBLogDebug(@"getConnectingServiceMask called");
	unsigned  val = %orig;
	return val;
}
-(void)setPIN:(id)arg1  {
	HBLogDebug(@"setPIN called");
	return %orig;
}
-(id)address {
	HBLogDebug(@"address called");
	id val = %orig;
	return val;
}
-(unsigned long long)connectedServices {
	HBLogDebug(@"connectedServices called");
	unsigned long long val = %orig;
	return val;
}
-(BOOL)connected {
	HBLogDebug(@"connected called");
	BOOL val = %orig;
	return val;
}
-(unsigned)majorClass {
	HBLogDebug(@"majorClass called");
	unsigned val = %orig;
	return val;
}
-(BOOL)cloudPaired {
	HBLogDebug(@"cloudPaired called");
	BOOL val = %orig;
	return val;
}
-(unsigned)listeningMode {
	HBLogDebug(@"listeningMode called");
	unsigned val = %orig;
	return val;
}
-(BOOL)setListeningMode:(unsigned)arg1  {
	HBLogDebug(@"setListeningMode called");
	BOOL val = %orig;
	return val;
}
-(unsigned)doubleTapAction{
	HBLogDebug(@"doubleTapAction called");
	unsigned val = %orig;
	return val;
}
-(BOOL)setDoubleTapAction:(unsigned)arg1 {
	HBLogDebug(@"setDoubleTapAction called");
	BOOL val = %orig;
	return val;
}
-(BOOL)inEarDetectEnabled {
	HBLogDebug(@"inEarDetectEnabled called");
	BOOL val = %orig;
	return val;
}
-(BOOL)setInEarDetectEnabled:(BOOL)arg1 {
	HBLogDebug(@"setInEarDetectEnabled called");
	BOOL val = %orig;
	return val;
}
-(unsigned)micMode {
	HBLogDebug(@"unsigned called");
	unsigned val = %orig;
	return val;
}
-(BOOL)setMicMode:(unsigned)arg1 {
	HBLogDebug(@"setMicMode called");
	BOOL val = %orig;
	return val;
}
-(unsigned)doubleTapCapability {
	HBLogDebug(@"doubleTapCapability called");
	unsigned val = %orig;
	return val;
}
-(void)setSyncGroup:(int)arg1 enabled:(BOOL)arg2 {
	HBLogDebug(@"setSyncGroup called");
	return %orig;
}
-(int)accessorySettingFeatureBitMask {
	HBLogDebug(@"accessorySettingFeatureBitMask called");
	int val = %orig;
	return val;
}
-(id)syncGroups {
	HBLogDebug(@"syncGroups called");
	id val = %orig;
	return val;
}
-(BOOL)paired {
	HBLogDebug(@"paired called");
	BOOL val = %orig;
	return val;
}
-(unsigned)minorClass {
	HBLogDebug(@"minorClass called");
	unsigned val = %orig;
	return val;
}
-(id)getServiceSetting:(unsigned)arg1 key:(id)arg2 {
	HBLogDebug(@"getServiceSetting called");
	id val = %orig;
	return val;
}
